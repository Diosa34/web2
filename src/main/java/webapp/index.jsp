...
<div class="center">
  <div class="graphic-part">
    <div class="svg">
      <svg viewBox="0 0 600 600" id="svg" onclick="svgClick(event, '${pageContext.request.contextPath}/ControllerServlet')">
      <path d="M 300 300
              L 200 300
              L 200 100
              L 300 100
